...
getopts("o:s:c:hn");
use vars qw($opt_o $opt_s $opt_c $opt_h $opt_n);
if ($opt_h){&printDocs;}
my $outfile=$opt_o;
my $data_summary_file = "/home/obig/Projects/thyroid/processed_data/Thyroid_literature_data_summary7.txt";
...
splice(@headers, 2, 0, ('Entry', 'Entrez_id', 'Entrez_name', 'Entrez_description', 'n_studies','n_comparisons','n_total_samples','Map_method'));
...
sub printDocs{
print "usage: mapThyroidSummary2.pl -o outfile -c 1,2,5,7,12 -n\n";
print "Options:
-o outfile
